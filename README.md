...
- 🔭 Şu anda **Demirbaş Takip** projesi üzerinde çalışıyorum
- 🌱 Öğrenmeye devam ettiklerim: **React ve .NET**
- 💬 Konuşabileceğimiz konular: **web geliştirme, Unity ve TypeScript**
- 📫 İletişim: **b.utku.uyanik@gmail.com**
...
|---|---|---|
| [Müzik Websitesi ve Uygulaması](https://github.com/BekirUtku/Muzik-Websitesi-Ve-Uygulamasi) | Kullanıcıların müzik dinleyip listelerini yönetebildiği web uygulaması | PHP, JavaScript, HTML, CSS |
| [Yapay Zeka Destekli Oyun](https://github.com/BekirUtku/Yapay-Zeka-Destekli-Oyunum) | Unity ile geliştirilmiş, yapay zeka davranışları içeren 2D oyun | Unity, C# |
| [Demirbaş Takip](https://github.com/BekirUtku/demirbastakip) | Kurumsal demirbaş envanterinin takibi için web uygulaması | TypeScript |

---

## Teknolojiler

**Diller:** TypeScript, JavaScript, PHP, C#  
**Web:** HTML5, CSS3, PHP, MySQL  
**Oyun:** Unity  
**Araçlar:** Git, VS Code
